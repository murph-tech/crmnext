...
export default function DashboardPage() {
  ...
  const remindersWidget = (
    <motion.div
      ...
      className="glass-card rounded-3xl p-6 h-full min-h-[500px]"
    >
      ...
      {reminders.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {reminders.map((reminder) => {
            ...
            return (
              <Link href="/activities" key={reminder.id}>
                <motion.div
                  whileHover={{ y: -2 }}
                  className={`p-5 rounded-2xl border transition-all hover:shadow-lg group cursor-pointer ${isOverdue
        ...
        <div className="space-y-3">
          <div>
            <div className="flex justify-between text-sm mb-1.5">
              ...
              <span className="font-medium text-gray-900">{stats?.dealsProgress || 0}%</span>
            </div>
            <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
              <motion.div
                initial={{ width: 0 }}
                animate={{ width: `${stats?.dealsProgress || 0}%` }}
          ...
          <div>
            <div className="flex justify-between text-sm mb-1.5">
              ...
              <span className="font-medium text-gray-900">{stats?.taskCompletionRate || 0}%</span>
            </div>
            <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
              <motion.div
                initial={{ width: 0 }}
  ...
  const recentActivityWidget = (
    <div className="glass-card rounded-3xl overflow-hidden p-6 h-full">
  ...
  return (
    <div>
      ...
      <DashboardLayout
        widgets={{
          stats: statsWidget,
          wonDeals: wonDealsWidget,
          dealsCount: dealsCountWidget,
          reminders: remindersWidget,
          quickActions: quickActionsWidget,
          recentActivity: recentActivityWidget
        }}
        defaultLayout={['stats', 'wonDeals', 'dealsCount', 'reminders', 'recentActivity', 'quickActions']}
      />
